            ...
            Tabs::make('Sections')->persistTabInQueryString()->columnSpanFull()->tabs([
                ...
                Tab::make('About')->schema([
                    Grid::make(2)->schema([
                        ...
                        $this->text('about_stat1_num', 'Stat 1 — number'),
                        $this->text('about_stat1_label', 'Stat 1 — label'),
                        $this->text('about_stat2_num', 'Stat 2 — number'),
                        $this->text('about_stat2_label', 'Stat 2 — label'),
                        $this->text('about_stat3_num', 'Stat 3 — number'),
                        $this->text('about_stat3_label', 'Stat 3 — label'),
                        $this->text('about_stat4_num', 'Stat 4 — number'),
                        $this->text('about_stat4_label', 'Stat 4 — label'),
                ...
                Tab::make('Contact')->schema([
                    Grid::make(2)->schema([
                        ...
                        $this->text('contact_studio_label', 'Studio — label'),
                        $this->area('contact_studio_value', 'Studio — address (allows <br>)'),
                        $this->text('contact_newwork_label', 'New Work — label'),
                        $this->text('contact_email_new', 'New Work — email'),
                        $this->text('contact_general_label', 'General — label'),
                        $this->text('contact_email_general', 'General — email'),
                        $this->text('contact_phone_label', 'Phone — label'),
                        $this->text('contact_phone', 'Phone — number'),
                    ]),
                ]),
